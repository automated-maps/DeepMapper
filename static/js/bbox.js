...
function formatBounds(bounds, proj) {
    ...
    if (gdal) {
        ...
        if (lngLat) {
            // formattedBounds = 'http://127.0.0.1:5000/bbox/' +xmin+' '+ymin+' '+xmax+' '+ymax ;
            // return json
            // formattedBounds = {
            //     "xmin": xmin,
            //     "ymin": ymin,
            ...
            // formattedBounds = <a href={formattedBounds1} target="_blank">Download</a>;
        } else {
            // formattedBounds = 'http://127.0.0.1:5000/bbox/'+ymin+' '+xmin+' '+ymax+' '+xmax;
            formattedBounds = ymin+','+xmin+','+ymax+','+xmax;
            // formattedBounds = {
            //     "xmin": xmin,
            //     "ymin": ymin,
    ...
    return JSON.stringify(formattedBounds);
}
...
$(document).ready(function() {
    ...
    */
    ...
    map = L.map('map', {editable: true}).setView([53.356225,-6.281595], 17);
    ...
    // LasithNiro : removed the aim on map
    ...
    */
    ...
    map.on('draw:created', function (e) {
        ...
        $('#boxbounds').val(formatBounds(bounds.getBounds(),'4326'));
